...
- [ ] 1. Set up project scaffolding and shared types
  - [ ] 1.1 Initialize backend Node.js + TypeScript project
  ...
  - [ ] 1.2 Initialize frontend React + TypeScript + Vite project
  ...
  - [ ] 1.3 Define shared TypeScript types in `frontend/src/types/index.ts`
    - Define `Role`, `BillingCycle`, `Status`, `User`, `Subscription` interfaces matching the design
    - _Requirements: 1.1–1.3, 2.1–2.6_

- [ ] 2. Implement the backend data layer and models
  - [ ] 2.1 Create backend data models and Zod schemas in `backend/src/models/`
  ...
  - [ ] 2.5 Create seed data in `backend/src/seed.ts`
  ...
  - [ ] 2.6 Implement in-memory subscription store in `backend/src/store/subscriptionStore.ts`
    - Implement `getAll`, `create`, `update`, `remove` functions using a seeded array
    - _Requirements: 3.1–3.5_

- [ ] 3. Implement the backend API routes and middleware
  - [ ] 3.1 Create RBAC middleware in `backend/src/middleware/rbac.ts`
  ...
  - [ ] 3.3 Implement subscription CRUD routes in `backend/src/routes/subscriptions.ts`
  ...
  - [ ] 3.8 Create Express app entry point in `backend/src/index.ts`
...
- [ ] 5. Implement frontend utility functions
  - [ ] 5.1 Implement spend and count utilities in `frontend/src/utils/calculations.ts`
  ...
  - [ ] 5.4 Implement renewal alert utility in `frontend/src/utils/renewalAlerts.ts`
...
- [ ] 6. Implement frontend API client
  - [ ] 6.1 Create API client in `frontend/src/api/subscriptionApi.ts`
...
- [ ] 7. Implement frontend React components
  ...
  - [ ] 7.6 Create `SubscriptionForm.tsx` component
  ...
  - [ ] 7.7 Create `SubscriptionTable.tsx` component
...
- [ ] 8. Wire everything together in `App.tsx`
  - [ ] 8.1 Implement root `App.tsx` component
